...
- `Click here to see the Polymaps example </examples/polymaps>`_ (will not work in Internet Explorer).  Thanks to Mike Bostock for hints on `SVG event handling <https://github.com/simplegeo/polymaps/blob/master/examples/tipsy/tipsy.html>`_.
  ...
  - `Click here to see a heatmap image overlay of household density </examples/polymaps-household-density>`_ (will not work in Internet Explorer).
  - `Click here to see a heatmap image overlay of school access </examples/polymaps-school-access>`_ (will not work in Internet Explorer).
